...
//  public abstract class BaseHueApi : HueApiClient
//  {
...
//    protected BaseHueApi(ILogger<BaseHueApi> logger, IHttpClientFactory httpClientFactory) : base(logger, httpClientFactory) { }
